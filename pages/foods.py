...
st.title("Find Culinary 🍕 Information about any Country", current_location)
...
# Get the index of the first occurrence of the target value
selected_location = st.selectbox(label="Select a Country", options=df['Country'], index=row_index)
